...
def main():
    ...
    main_workflow = (
        ...
        .add_metadata(Loader(url, default_branch))
        .filter_operator("default_branch in ['main', 'master']")
        .add_metadata(Loader(url, nb_workflow_config_files))
        .filter_operator("nb_workflow_config_files > 0")
        .add_metadata(Loader(url, has_active_ci_workflow))
        .filter_operator("has_active_ci_workflow > 0")
        .manual_sampling_operator()
        .add_metadata(Loader(url, nb_runs_ci))
        .filter_operator("nb_runs_ci > 100")
        .add_metadata(Loader(url, last_run_ci, first_run_ci))
    ...
    w_step_6 = (
        ...
        .add_metadata(Loader(url, nb_runs))
        ...
        .add_metadata(Loader(url, has_updates_in_2023))
